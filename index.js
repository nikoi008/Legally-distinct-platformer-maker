...
Module['FS_createPath']("/sprites", "blocks", true, true);
Module['FS_createPath']("/sprites", "menu", true, true);
Module['FS_createPath']("/sprites", "player", true, true);
    ...
    loadPackage({"files": [{"filename": "/audio/pickupCoin.wav", "start": 0, "end": 3567}, {"filename": "/sprites/blocks/air.png", "start": 3567, "end": 3652}, {"filename": "/sprites/blocks/brick.png", "start": 3652, "end": 3786}, {"filename": "/sprites/blocks/cbBlue0.png", "start": 3786, "end": 3931}, {"filename": "/sprites/blocks/cbBlue1.png", "start": 3931, "end": 4045}, {"filename": "/sprites/blocks/cbRed0.png", "start": 4045, "end": 4197}, {"filename": "/sprites/blocks/cbRed1.png", "start": 4197, "end": 4311}, {"filename": "/sprites/blocks/checkpoint.png", "start": 4311, "end": 4493}, {"filename": "/sprites/blocks/coin.png", "start": 4493, "end": 4630}, {"filename": "/sprites/blocks/end.png", "start": 4630, "end": 4787}, {"filename": "/sprites/blocks/flag.png", "start": 4787, "end": 4943}, {"filename": "/sprites/blocks/ground.png", "start": 4943, "end": 5042}, {"filename": "/sprites/blocks/hedge.png", "start": 5042, "end": 5183}, {"filename": "/sprites/blocks/spike.png", "start": 5183, "end": 5330}, {"filename": "/sprites/menu/Sprite-0002.png", "start": 5330, "end": 7257}, {"filename": "/sprites/menu/bg.png", "start": 7257, "end": 237711}, {"filename": "/sprites/menu/flag_warning.png", "start": 237711, "end": 238022}, {"filename": "/sprites/menu/play.png", "start": 238022, "end": 238177}, {"filename": "/sprites/menu/player2.png", "start": 238177, "end": 241992}, {"filename": "/sprites/player/player.png", "start": 241992, "end": 242175}], "remote_package_size": 242175});

  })();

// end include: /tmp/tmpsuslm3tb.js
// include: /tmp/tmpo2999peg.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpo2999peg.js
// include: /tmp/tmp4t2fuuqj.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp4t2fuuqj.js
...
var ASM_CONSTS = {
  125930: () => { if (document.fullscreenElement) return 1; },  
 125976: () => { return Module.canvas.width; },  
 126008: () => { return parseInt(Module.canvas.style.width); },  
 126056: () => { document.exitFullscreen(); },  
 126083: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 126155: () => { if (document.fullscreenElement) return 1; },  
 126201: () => { return Module.canvas.width; },  
 126233: () => { return screen.width; },  
 126258: () => { document.exitFullscreen(); },  
 126285: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 126479: () => { return window.innerWidth; },  
 126505: () => { return window.innerHeight; },  
 126532: () => { if (document.fullscreenElement) return 1; },  
 126578: () => { return Module.canvas.width; },  
 126610: () => { return parseInt(Module.canvas.style.width); },  
 126658: () => { if (document.fullscreenElement) return 1; },  
 126704: () => { return Module.canvas.width; },  
 126736: () => { return screen.width; },  
 126761: () => { return window.innerWidth; },  
 126787: () => { return window.innerHeight; },  
 126814: () => { if (document.fullscreenElement) return 1; },  
 126860: () => { return Module.canvas.width; },  
 126892: () => { return screen.width; },  
 126917: () => { document.exitFullscreen(); },  
 126944: () => { if (document.fullscreenElement) return 1; },  
 126990: () => { return Module.canvas.width; },  
 127022: () => { return parseInt(Module.canvas.style.width); },  
 127070: () => { document.exitFullscreen(); },  
 127097: ($0) => { Module.canvas.style.opacity = $0; },  
 127135: () => { return screen.width; },  
 127160: () => { return screen.height; },  
 127186: () => { return window.screenX; },  
 127213: () => { return window.screenY; },  
 127240: () => { return window.devicePixelRatio; },  
 127276: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 127329: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 127380: () => { Module.canvas.style.cursor = 'none'; },  
 127417: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 127673: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 127724: () => { if (document.pointerLockElement) return 1; },  
 127771: () => { if (document.fullscreenElement) return 1; },  
 127817: () => { return window.innerWidth; },  
 127843: () => { return window.innerHeight; },  
 127870: ($0, $1, $2, $3, $4) => { if (typeof window === 'undefined' || (window.AudioContext || window.webkitAudioContext) === undefined) { return 0; } if (typeof(window.miniaudio) === 'undefined') { window.miniaudio = { referenceCount: 0 }; window.miniaudio.device_type = {}; window.miniaudio.device_type.playback = $0; window.miniaudio.device_type.capture = $1; window.miniaudio.device_type.duplex = $2; window.miniaudio.device_state = {}; window.miniaudio.device_state.stopped = $3; window.miniaudio.device_state.started = $4; let miniaudio = window.miniaudio; miniaudio.devices = []; miniaudio.track_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == null) { miniaudio.devices[iDevice] = device; return iDevice; } } miniaudio.devices.push(device); return miniaudio.devices.length - 1; }; miniaudio.untrack_device_by_index = function(deviceIndex) { miniaudio.devices[deviceIndex] = null; while (miniaudio.devices.length > 0) { if (miniaudio.devices[miniaudio.devices.length-1] == null) { miniaudio.devices.pop(); } else { break; } } }; miniaudio.untrack_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == device) { return miniaudio.untrack_device_by_index(iDevice); } } }; miniaudio.get_device_by_index = function(deviceIndex) { return miniaudio.devices[deviceIndex]; }; miniaudio.unlock_event_types = (function(){ return ['touchend', 'click']; })(); miniaudio.unlock = function() { for(var i = 0; i < miniaudio.devices.length; ++i) { var device = miniaudio.devices[i]; if (device != null && device.webaudio != null && device.state === miniaudio.device_state.started) { device.webaudio.resume().then(() => { _ma_device__on_notification_unlocked(device.pDevice); }, (error) => {console.error("Failed to resume audiocontext", error); }); } } miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); }; miniaudio.unlock_event_types.map(function(event_type) { document.addEventListener(event_type, miniaudio.unlock, true); }); } window.miniaudio.referenceCount += 1; return 1; },  
 130048: () => { if (typeof(window.miniaudio) !== 'undefined') { window.miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, window.miniaudio.unlock, true); }); window.miniaudio.referenceCount -= 1; if (window.miniaudio.referenceCount === 0) { delete window.miniaudio; } } },  
 130352: () => { return (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined); },  
 130456: () => { try { var temp = new (window.AudioContext || window.webkitAudioContext)(); var sampleRate = temp.sampleRate; temp.close(); return sampleRate; } catch(e) { return 0; } },  
 130627: ($0, $1, $2, $3, $4, $5) => { var deviceType = $0; var channels = $1; var sampleRate = $2; var bufferSize = $3; var pIntermediaryBuffer = $4; var pDevice = $5; if (typeof(window.miniaudio) === 'undefined') { return -1; } var device = {}; var audioContextOptions = {}; if (deviceType == window.miniaudio.device_type.playback && sampleRate != 0) { audioContextOptions.sampleRate = sampleRate; } device.webaudio = new (window.AudioContext || window.webkitAudioContext)(audioContextOptions); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; var channelCountIn = 0; var channelCountOut = channels; if (deviceType != window.miniaudio.device_type.playback) { channelCountIn = channels; } device.scriptNode = device.webaudio.createScriptProcessor(bufferSize, channelCountIn, channelCountOut); device.scriptNode.onaudioprocess = function(e) { if (device.intermediaryBufferView == null || device.intermediaryBufferView.length == 0) { device.intermediaryBufferView = new Float32Array(HEAPF32.buffer, pIntermediaryBuffer, bufferSize * channels); } if (deviceType == window.miniaudio.device_type.capture || deviceType == window.miniaudio.device_type.duplex) { for (var iChannel = 0; iChannel < channels; iChannel += 1) { var inputBuffer = e.inputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { intermediaryBuffer[iFrame*channels + iChannel] = inputBuffer[iFrame]; } } _ma_device_process_pcm_frames_capture__webaudio(pDevice, bufferSize, pIntermediaryBuffer); } if (deviceType == window.miniaudio.device_type.playback || deviceType == window.miniaudio.device_type.duplex) { _ma_device_process_pcm_frames_playback__webaudio(pDevice, bufferSize, pIntermediaryBuffer); for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { var outputBuffer = e.outputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { outputBuffer[iFrame] = intermediaryBuffer[iFrame*channels + iChannel]; } } } else { for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { e.outputBuffer.getChannelData(iChannel).fill(0.0); } } }; if (deviceType == window.miniaudio.device_type.capture || deviceType == window.miniaudio.device_type.duplex) { navigator.mediaDevices.getUserMedia({audio:true, video:false}) .then(function(stream) { device.streamNode = device.webaudio.createMediaStreamSource(stream); device.streamNode.connect(device.scriptNode); device.scriptNode.connect(device.webaudio.destination); }) .catch(function(error) { console.log("Failed to get user media: " + error); }); } if (deviceType == window.miniaudio.device_type.playback) { device.scriptNode.connect(device.webaudio.destination); } device.pDevice = pDevice; return window.miniaudio.track_device(device); },  
 133504: ($0) => { return window.miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 133577: ($0) => { var device = window.miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 133977: ($0) => { window.miniaudio.untrack_device_by_index($0); },  
 134027: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = window.miniaudio.device_state.started; },  
 134166: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; }
};
